...
public enum FfiConverterTypeStockOwnershipClient implements FfiConverter<StockOwnershipClient, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(StockOwnershipClient value) {
        return value.uniffiClonePointer();
    }

    @Override
    public StockOwnershipClient lift(Pointer value) {
        return new StockOwnershipClient(value);
    }

    @Override
    public StockOwnershipClient read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(StockOwnershipClient value) {
      return 8L;
    }

    @Override
    public void write(StockOwnershipClient value, ByteBuffer buf) {
