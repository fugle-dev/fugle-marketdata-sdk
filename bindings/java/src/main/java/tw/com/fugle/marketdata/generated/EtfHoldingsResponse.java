 ...
 */
public class EtfHoldingsResponse {
    private String dataType;
    private String exchange;
    private String market;
    private String symbol;
    private List<EtfHoldingsEntry> data;

    public EtfHoldingsResponse(
        String dataType, 
        String exchange, 
        String market, 
        String symbol, 
        List<EtfHoldingsEntry> data
    ) {
    ...
    public List<EtfHoldingsEntry> data() {
        return this.data;
    }
    ...
    public void setData(List<EtfHoldingsEntry> data) {
        this.data = data;
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof EtfHoldingsResponse) {
            EtfHoldingsResponse t = (EtfHoldingsResponse) other;
            return (
