...
impl FutOptHistoricalClient {
    ...
    #[napi(
        ...
        ts_args_type = "symbol: string | RestFutOptHistoricalCandlesParams, from?: string, to?: string, timeframe?: string, afterHours?: boolean, contractMonth?: string, fields?: string, sort?: 'asc' | 'desc'"
    )]
    ...
    #[napi(
        ...
        ts_args_type = "symbol: string | RestFutOptHistoricalDailyParams, date?: string, afterHours?: boolean"
    )]
    pub async fn daily(
        &self,
        symbol: Option<RestArg>,
