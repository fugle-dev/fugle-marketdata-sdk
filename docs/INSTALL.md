...
|---|---|---|
| Bindings | Python, Node.js | `3.0.0-rc.6` (PyPI spells it `3.0.0rc6`) |
...
```bash
pip install --pre "fugle-marketdata==3.0.0rc6"
```
...
TAG=v3.0.0-rc.6     # the bindings release that shipped this UniFFI version
