...
|---|---|---|
| Bindings | Python, Node.js | `3.0.0-rc.1` (PyPI spells it `3.0.0rc1`) |
| UniFFI | C#, Go, C++ | `0.1.0-rc.1` |
| Rust crates | Rust | `0.8.0-rc.1` |
...
```bash
pip install --pre "fugle-marketdata==3.0.0rc1"
```
...
```bash
CGO_ENABLED=1 go get github.com/fugle-dev/fugle-marketdata-go@v0.1.0-rc.1
```
...
TAG=v3.0.0-rc.1     # the bindings release that shipped this UniFFI version
