...
|---|---|---|
| Bindings | Python, Node.js | `3.0.0-rc.2` (PyPI spells it `3.0.0rc2`) |
| UniFFI | C#, Go, C++ | `0.2.0-rc.1` |
| Rust crates | Rust | `0.9.0-rc.1` |
...
```bash
pip install --pre "fugle-marketdata==3.0.0rc2"
```
...
```bash
CGO_ENABLED=1 go get github.com/fugle-dev/fugle-marketdata-go@v0.2.0-rc.1
```
...
TAG=v3.0.0-rc.2     # the bindings release that shipped this UniFFI version
