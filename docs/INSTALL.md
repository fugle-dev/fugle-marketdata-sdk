...
|---|---|---|
| Bindings | Python, Node.js | `3.0.0-rc.5` (PyPI spells it `3.0.0rc5`) |
| UniFFI | C#, Go, C++ | `0.2.0-rc.4` |
| Rust crates | Rust | `0.9.0-rc.4` |
...
```bash
pip install --pre "fugle-marketdata==3.0.0rc5"
```
